...
HD_PWD='C:/Users/sunda/Desktop/fft/fft/fft.runs/fft_soc_dlmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_soc_dlmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_soc_dlmb_bram_if_cntlr_1.tcl

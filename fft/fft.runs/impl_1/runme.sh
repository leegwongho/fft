...
HD_PWD='C:/Users/sunda/Desktop/fft/fft/fft.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_soc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fft_soc_wrapper.tcl -notrace

...
HD_PWD='C:/Users/sunda/Desktop/fft/fft/fft.runs/fft_soc_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_soc_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_soc_xbar_0.tcl
